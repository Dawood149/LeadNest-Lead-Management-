    ...
    <>
      ...
      <div className={`h-full bg-zinc-700 m-2 rounded transition-all duration-300 ease-in-out ${isOpen ? 'w-64' : 'w-20'}`}>
        ...
        <div className="text-white font-bold mt-8 flex justify-center">
          <ul className={`space-y-20 ${isOpen ? 'w-full px-4' : 'w-full px-2'}`}>
            {/* Dashboard */}
            <li className="transition duration-200 ease-in-out hover:scale-110 ">
              <NavLink
                to={'/dashboard'}
                className={({ isActive }) =>
                  `flex items-center gap-2 p-2 rounded transition duration-200 ease-in-out hover:scale-110 ${isActive

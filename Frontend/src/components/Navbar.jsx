                    ...
                    <div className='absolute right-50 flex gap-15'>
                        <div className="flex">
                            <input
                                ...
                                id="email"
                                placeholder="Search"
                                className="w-full px-4 py-2 border border-gray-600 rounded-l-md bg-white text-gray-800 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-white focus:shadow-md transition duration-200"
                            />
                        ...
                        <div>
                            ...
                            {notificationPanelOpen && (
                                <div className="text-black left-0 absolute mt-3 w-100 h-100 bg-white-700 rounded-lg shadow-xl py-1 z-10 border">
                                    <button
